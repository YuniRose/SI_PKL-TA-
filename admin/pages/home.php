          ...
          <div class="col-lg-6 col-xs-6">
            ...
            <div class="col-lg-6 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <a href="index.php?p=list-mahasiswa-sudah-dinilai" class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
              ...
              <div class="small-box bg-yellow">
                <div class="inner">
                  <?php
                    ...
                    ?>
                  <h3><?php echo $q3; ?></h3>
                  <p>Nilai Mahasiswa di Instansi</p>
                </div>
                <div class="icon">
                  <i class="fa fa-files-o"></i>
                </div>
              ...
              <div class="small-box bg-red">
                <div class="inner">
                  <?php
                    ...
                    $sql4=mysqli_query($koneksi,"SELECT * FROM tb_periode_penilaian where untuk='Dosen'");
                    $q4=mysqli_num_rows($sql4);
                    ?>
                  <h3><?php echo $q4; ?></h3>
                  <p>Priode Penilaian Dosen</p>
                </div>
                <div class="icon">
                  <i class="fa fa-calendar"></i>
                </div>
                <a href="index.php?p=list-periode2" class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
          <?php }else{ ?>
             <div class="col-lg-3 col-xs-6">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <a href="index.php?p=list-nilai-instansi-mahasiswa-pro2&id=<?php echo $id; ?>" class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-green">
                ...
                <a href="index.php?p=list-nilai-dosen-mahasiswa-pro2&id=<?php echo $id; ?>" class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
